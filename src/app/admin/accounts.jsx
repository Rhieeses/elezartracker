...
export default function Accounts() {
	...
	const [position, setPosition] = useState(new Set([]));
	...
	const handleDelete = (id) => {
		alert(id);
		axios
			.delete('/api/delete-account', { data: { id } })
			.then((response) => {
	...
	return (
		<div className='h-fit'>
			<div className='p-10 mb-5 border-b-[1px] flex space-x-4 items-center justify-between'>
				...
				<Button onPress={onOpen}>Create new account</Button>
			</div>
