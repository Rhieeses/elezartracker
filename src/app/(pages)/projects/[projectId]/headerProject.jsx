...
export default function HeaderProject({ children, projectName }) {
	...
	return (
		<div className='flex flex-col h-screen text-black'>
			<header className='flex flex-col w-full bg-white pt-2 h-fit'>
				...
				<div className='sticky top-0 z-10 h-full bg-white no-scrollbar w-full overflow-x-scroll lg:overflow-x-hidden '>
					<div className='flex items-center space-x-4 col-span-4 p-5'>
						<span
						...
						<h1 className='col-span-4'>{projectName}</h1>
					</div>
				</div>
