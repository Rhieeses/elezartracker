...
import { formatNumberDecimal, calculateDateDifference, formatDate } from '@/utils/inputFormatter';
			...
			<div className='grid grid-cols-2 lg:grid-cols-4 gap-10 h-fit p-10'>
				<div className='rounded border p-2'>
					...
					<Progress
						...
						label={`${formatNumberDecimal(
							project.projectAccounts.total_paid,
						)} / ${formatNumberDecimal(project.projectAccounts.contract_price)}`} //'$975,000.00 / $1,500,000.00 paid'
						value={Math.round(
				...
				<div className='rounded border p-2'>
					...
					<Progress
						...
						)} / ${formatNumberDecimal(project.projectAccounts.contract_price)} remaining`}
						value={Math.round(
							project.projectAccounts.total_paid / project.projectAccounts.contract_price,
						)}
						showValueLabel={true}
